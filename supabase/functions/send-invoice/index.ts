        ...
        <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(32, 47, 33, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px 0; color: #202F21; font-size: 24px; font-weight: 600;">Invoice ${invoiceNumber}</h2>
              ...
              <p style="margin: 0 0 20px 0; color: #202F21; font-size: 16px;">
                Please find attached the invoice for your reference and payment.
              </p>
              
              <div style="background-color: #F0E8D8; border-left: 4px solid #BDC4A5; padding: 20px; margin: 30px 0; border-radius: 4px;">
                <p style="margin: 0 0 10px 0; color: #202F21; font-size: 14px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Invoice Details</p>
                <p style="margin: 5px 0; color: #202F21; font-size: 16px;"><strong>Invoice Number:</strong> ${invoiceNumber}</p>
                <p style="margin: 5px 0; color: #202F21; font-size: 16px;"><strong>Quotation Reference:</strong> ${quotationNumber || 'N/A'}</p>
                <p style="margin: 5px 0; color: #202F21; font-size: 16px;"><strong>Invoice Date:</strong> ${formattedDate}</p>
                <p style="margin: 5px 0; color: #202F21; font-size: 16px;"><strong>Amount Due:</strong> RM ${parseFloat(amount).toFixed(2)}</p>
              </div>
              
              <p style="margin: 20px 0; color: #202F21; font-size: 16px;">
                Please find the detailed invoice attached as a PDF document. The invoice includes all services, pricing, and payment terms.
              </p>
              
              <p style="margin: 20px 0; color: #202F21; font-size: 16px;">
                If you have any questions regarding this invoice, please do not hesitate to contact us. We appreciate your prompt payment.
              </p>
