...
Deno.serve(async (req) => {
  try {
    // Get the quotation details from the request
    const { 
      quotationId, 
      quotationNumber, 
      customerName, 
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #F0E8D8; line-height: 1.6;">
  <table role="presentation" style="width: 100%; border-collapse: collapse; background-color: #F0E8D8; padding: 20px;">
        ...
        <table role="presentation" style="max-width: 600px; width: 100%; border-collapse: collapse; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(32, 47, 33, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 20px 0; color: #202F21; font-size: 24px; font-weight: 600;">Quotation ${quotationNumber}</h2>
              ...
              <p style="margin: 0 0 20px 0; color: #202F21; font-size: 16px;">
                Thank you for your interest in our services. We are pleased to present you with the following quotation.
              </p>
              
              <div style="background-color: #F0E8D8; border-left: 4px solid #BDC4A5; padding: 20px; margin: 30px 0; border-radius: 4px;">
                <p style="margin: 0 0 10px 0; color: #202F21; font-size: 14px; font-weight: 600; text-transform: uppercase; letter-spacing: 0.5px;">Quotation Details</p>
                <p style="margin: 5px 0; color: #202F21; font-size: 16px;"><strong>Quotation Number:</strong> ${quotationNumber}</p>
                <p style="margin: 5px 0; color: #202F21; font-size: 16px;"><strong>Date:</strong> ${formattedDate}</p>
                <p style="margin: 5px 0; color: #202F21; font-size: 16px;"><strong>Total Amount:</strong> RM ${parseFloat(totalAmount).toFixed(2)}</p>
              </div>
              
              <p style="margin: 20px 0; color: #202F21; font-size: 16px;">
                Please find the detailed quotation attached as a PDF document. The quotation includes all services, pricing, and terms as discussed.
              </p>
              
              <p style="margin: 20px 0; color: #202F21; font-size: 16px;">
                If you have any questions or require any clarifications, please do not hesitate to contact us. We look forward to working with you.
              </p>
          ...
          <tr>
            <td style="background-color: #898D74; padding: 25px 40px; text-align: center;">
              ...
              <p style="margin: 5px 0; color: #ffffff; font-size: 13px;">Phone: 016-753 5323 | Email: contact@aspialproduction.com</p>
            </td>
          </tr>
        </table>
      </td>
    ...
    const data = await resend.emails.send({
      ...
      subject: `Quotation ${quotationNumber} - Aspial Production`,
      html: emailHtml,
      attachments: [
        {
