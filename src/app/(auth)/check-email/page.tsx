        ...
        <div className="text-center">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              ...
              <CheckCircle className="w-6 h-6 text-green-500 dark:text-green-400 absolute -top-1 -right-1" />
            </div>
          </div>
          ...
          {/* Additional Info */}
          <div className="bg-accent/50 border border-accent/50 rounded-lg p-4 mb-6">
