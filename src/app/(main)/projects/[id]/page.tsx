...
import { ArrowLeft, Calendar, User, DollarSign, Clock, Users, Edit3 } from "lucide-react";
...
export default function ProjectPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--mediumGreen)]">
      {/* Main Content Area */}
      <div className="p-6">
          ...
          <Card className="bg-white">
            <CardContent className="p-6">
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="w-16 h-16 bg-[var(--mediumGreen)] rounded-full flex items-center justify-center">
