...
interface ProjectDetailClientProps {
	...
	initialTab: "overview" | "tasks" | "complaints" | "contracts"
}
...
export default function ProjectDetailClient({
	...
	// Local state for project data (can be updated after mutations)
	const [projectData, setProjectData] = useState<ProjectWithDetails>(initialProjectData)
	const project = projectData.project
	const collaborators = projectData.collaborators
	const taskStats = projectData.taskStats
	const userPermission = projectData.userPermission
								...
								<CardContent className="space-y-4">
									<div className="flex items-center gap-3">
										...
										<div>
											...
											<div className="text-sm text-black">Team Lead</div>
										</div>
									</div>
									...
									{(isProjectOwner || isAdmin) && !isProjectCancelled && (
										<>
											...
											<CreateComplaintDialog
												...
												onComplaintCreated={handleComplaintUpdated}
											/>
										</>
									)}
									{isProjectCancelled && (
					...
					<div className="py-4 space-y-4">
						<div className="p-4 bg-green-50 border border-green-200 rounded-lg">
							<p className="text-sm text-green-800">
								⚠️ This will reactivate the cancelled project and allow team members to work on it again.
							</p>
						</div>
